...
function ChatBot() {
  ...
  const chatContext =
    ...
    When asked about a patient, you can only provide information about status and name if the user role is a guest, you can provide all information if the user is admin or surgeon.`;
