...
function ChatBot() {
  ...
  const chatContext =
    ...
    - Surgical team: Can search for a patient by patient number, update patient information, update patient status, and add new patients.
    ...
    When asked about a patient, you can only provide information about status and name if the user role is a guest, you can provide all information if the user is admin or surgical team.`;
